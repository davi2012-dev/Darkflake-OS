...

{
  networking.firewall = {
    ...
    allowedTCPPorts = [
      22 80 139 443 445 631 3000 4460 51820 8080 8083 8123 9090 53317
    ];

    allowedUDPPorts = [
      123 631 3544 4460 5353 41641
    ];
  ...
  boot.kernel.sysctl = {
    ...
    "22,80,139,443,445,631,4460,51820,8080,3000,8123,9090,8083,53317";
