...

{
  ...
  hardware.bluetooth = {
    ...
    settings = {
      General = {
        ...
        Class = "0x000100";
        # Alinhamento para múltiplos perfis e baixa latência (Controles + Áudio)
  ...
  services.udev.extraRules = ''
    # USB e HID acessíveis
    SUBSYSTEMS=="usb", TAG+="uaccess"
    KERNEL=="hidraw*", TAG+="uaccess"
    KERNEL=="uinput", SUBSYSTEM=="misc", TAG+="uaccess", OPTIONS+="static_node=uinput"

    # Xbox 360 (Cabo e Receptor)
